...
/**
 * For the cron string specification, see http://unixhelp.ed.ac.uk/CGI/man-cgi?crontab+5 for instance.
 *
 * Expected arguments: <code>&lt;cron string&gt; &lt;from timestamp&gt; &lt;to timestamp&gt;</code>
 */
